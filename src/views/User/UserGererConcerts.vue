<template>
  <ion-page>
    <header-component page-title="Gestion des concerts" page-default-back-link="/user"></header-component>
      ...
      <ion-content :fullscreen="true">
        ...
        <ion-button class="add-button" color="success" :router-link="`/user/concerts/create`">Ajouter un concert
        ...
        <ion-list>
            <ion-item v-for="concert in concerts" v-bind:key="concert.id">
              <ion-card class="ion-card" color="light">
                ...
                <ion-button class="buttons" color="tertiary" :router-link="`/user/concerts/details/${concert.id}`">Voir
...
<script>
  ...
  export default defineComponent ({
    ...
    setup() {
      ...
      store.dispatch("getConcerts",user_id);
    ...
    return {handleLogout, logOut, calendarNumber, time, eye, create, trash, addCircleOutline, pricetags, deleteConcert, formatDate, concerts};
  },
